...
import _base
from lib.html5lib.constants import cdataElements, rcdataElements, voidElements

from lib.html5lib.constants import spaceCharacters
    ...
    def __iter__(self):
        ...
        for token in _base.Filter.__iter__(self):
            ...
            if type in ("StartTag", "EmptyTag"):
                ...
                if start_name != name:
                    raise LintError(_(u"EndTag (%name) does not match StartTag (%start_name)") % {'name':name, 'start_name':start_name})
                contentModelFlag = "PCDATA"
